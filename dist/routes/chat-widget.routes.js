...
router.get('/chat-widget', async (req, res) => {
    ...
    try {
        const configRes = await axios_1.default.get(`${BACKEND_URL}/api/chatboxes/by-name/${name}`);
        ...
        const { themeColor = '#6366f1', textFont = 'Inter, -apple-system, BlinkMacSystemFont, sans-serif', displayName = 'AI Assistant', profileAvatar = '', } = chatbox.configuration || {};
